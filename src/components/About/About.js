...
const About = () => {
    return (
        <div className='d-flex align-items-center row'>
            ...
            <div className='col-6'>
                <p className="fs-5 text-muted">Welcome to Ed Tech, your number one source for all things our courses. We're dedicated to giving you the very best of coureses, with a focus on skilled and learning of.
